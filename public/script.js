...
function botTyping(){
    ...
    /* CUỘN XUỐNG KHI HIỆN TRẠNG THÁI ĐANG GÕ */
    autoScroll();
}
...
if ('webkitSpeechRecognition' in window) {
    ...
    recognition.onresult = (event) => {
        ...
        /* CUỘN XUỐNG KHI CHỮ ĐANG ĐƯỢC NHẬP TỪ GIỌNG NÓI */
        autoScroll();
    }
}
